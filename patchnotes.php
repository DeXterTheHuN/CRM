...
// Use PatchnotesRepository to get patchnotes with read status
$patchRepo = new PatchnotesRepository($pdo);
$patchnotes = $patchRepo->getAllWithReadStatus($user_id);
?>
<!DOCTYPE html>
<html lang="hu">
                    ...
                    <div class="modal-body">
                        <form id="addPatchnoteForm">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" placeholder="pl. Új chat funkció"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="content" class="form-label">Tartalom *</label>
                                <textarea class="form-control" id="content" rows="8"
                                    placeholder="Részletes leírás a változásokról..." required></textarea>
                            </div>
