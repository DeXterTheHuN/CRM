        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center gap-2 gap-md-3 flex-wrap justify-content-end">
                    <a href="chat.php" class="btn btn-outline-primary btn-sm position-relative"
                        style="overflow: visible;" title="Chat" id="chatLink">
                        <i class="bi bi-chat-dots-fill"></i> <span class="d-none d-md-inline">Chat</span>
                        <span class="badge bg-danger rounded-pill" id="chatBadge" style="display: none;">0</span>
                    </a>
                    <a href="patchnotes.php" class="btn btn-outline-success btn-sm position-relative"
                        style="overflow: visible;" title="Változásnapló" id="patchnotesLink">
                        <i class="bi bi-journal-text"></i> <span class="d-none d-md-inline">Változások</span>
                        <span class="badge bg-success rounded-pill" id="patchnotesBadge" style="display: none;">0</span>
                    </a>
                    ...
                    <?php if (isAdmin()): ?>
                        ...
                        <a href="approvals.php" class="btn btn-outline-warning btn-sm position-relative"
                            style="overflow: visible;" title="Jóváhagyások" id="approvalsLink">
                            <i class="bi bi-clock-history"></i> <span class="d-none d-md-inline">Jóváhagyások</span>
                            <span class="badge bg-danger rounded-pill" id="approvalsBadge" style="display: none;">0</span>
                        </a>
                    ...
                    <?php else: ?>
                        <a href="my_requests.php" class="btn btn-outline-info btn-sm position-relative"
                            style="overflow: visible;" title="Saját Kérések" id="myRequestsLink">
                            <i class="bi bi-file-earmark-text"></i> <span class="d-none d-md-inline">Saját Kérések</span>
                            <span class="badge bg-info rounded-pill" id="myRequestsBadge" style="display: none;">0</span>
                        </a>
                    <?php endif; ?>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="badge bg-success new-client-badge"
                                                data-county-id="<?php echo $county['id']; ?>" style="display: none;">0
                                                új</span>
                                        </div>
                                    </div>
                                </div>
