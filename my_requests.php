...
// Lekérjük a felhasználó által létrehozott ügyfeleket
$my_clients = $clientRepo->getClientsByCreatorId($user_id);
...
// Települések, ügyintézők és megyék lekérdezése az űrlaphoz (újraküldéshez)
...
<body class="page-my-requests">
    ...
    <div class="container">
                                            ...
                                            <td>
                                                ...
                                                <?php if ($client['rejection_reason']): ?>
                                                    <div class="rejection-reason mt-2">
                                                        <strong><i class="bi bi-exclamation-triangle"></i> Elutasítás
                                                            indoka:</strong>
                                                        <p class="mb-0 mt-1">
                                                            <?php echo nl2br(escape($client['rejection_reason'])); ?>
                                                        </p>
                                                    </div>
                                                <?php endif; ?>
                                            </td>
        ...
        <div class="mt-4">
            <div class="alert alert-info">
                ...
                <ul class="mb-0 mt-2">
                    <li><strong>Függőben:</strong> Az általad létrehozott ügyfelek, amelyek még adminisztrátori
                        jóváhagyásra várnak</li>
                    <li><strong>Elfogadva:</strong> A jóváhagyott ügyfelek már megjelennek a megyei listákban és
                        szerkeszthetők</li>
                    <li><strong>Elutasítva:</strong> Az elutasított ügyfelek indoklással - tanulj belőlük a jövőbeli
                        beküldésekhez</li>
                </ul>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">
                        <strong><i class="bi bi-info-circle"></i> Fontos:</strong> Javítsd ki az elutasítás okát, majd
                        küldd újra jóváhagyásra!
                    </div>
    ...
    <script>
        // Mark all approval notifications as read when this page loads
        document.addEventListener('DOMContentLoaded', function () {
