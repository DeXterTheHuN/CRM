...
<head>
    ...
    <style>
        ...
        /*
         * A "Tömeges műveletek" (kijelölés menü) panel eredetileg a táblázat
         * tetején helyezkedett el, így ahogy a felhasználó lefelé görgetett,
         * el is tűnt a szem elől. Annak érdekében, hogy ne kelljen a lista
         * tetejére visszagörgetni a műveletekhez, tegyük a panelt
         * „ragadós” (sticky) pozícióba. Ezzel a panel a megadott
         * függőleges pozíciónál (a fejléc alatt) letapad és végig látható
         * marad, amíg vannak kijelölt sorok. A z‑index biztosítja, hogy a
         * panel mindig a táblázat sorai fölött jelenjen meg.
         */
        #bulk-actions-panel {
            position: sticky;
            top: 80px;
            /* fejléctől számított eltolás – szükség esetén igazítható */
            z-index: 1040;
        }
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div class="d-flex align-items-center gap-2 gap-md-3 flex-wrap justify-content-end">
                    <a href="chat.php" class="btn btn-outline-primary btn-sm position-relative" title="Chat"
                        id="chatLink">
                        <i class="bi bi-chat-dots-fill"></i> <span class="d-none d-md-inline">Chat</span>
                        <span class="badge bg-danger rounded-pill position-absolute top-0 start-100 translate-middle"
                            id="chatBadge" style="display: none; font-size: 0.7rem;">0</span>
                    </a>
                    <a href="patchnotes.php" class="btn btn-outline-success btn-sm" title="Változásnapló"
                        id="patchnotesLink">
                    ...
                    <?php if (isAdmin()): ?>
                        ...
                        <a href="approvals.php" class="btn btn-outline-warning btn-sm position-relative"
                            ...
                            <span class="badge bg-danger rounded-pill position-absolute top-0 start-100 translate-middle"
                                id="approvalsBadge" style="display: none; font-size: 0.7rem;">0</span>
                        </a>
                    ...
                    <?php else: ?>
                        <a href="my_requests.php" class="btn btn-outline-info btn-sm position-relative"
                            ...
                            <span class="badge bg-info rounded-pill position-absolute top-0 start-100 translate-middle"
                                id="myRequestsBadge" style="display: none; font-size: 0.7rem;">0</span>
                        </a>
                    <?php endif; ?>
...
// 2. Ő van hozzárendelve (agent_id == current_user_agent_id)
                            ...
                            <tr class="client-row <?php echo $can_edit ? '' : 'locked-row'; ?>"
                                ...
                                <td>
                                    ...
                                    <?php if (!empty($client['notes'])): ?>
                                        <i class="bi bi-chat-left-text-fill text-primary ms-2"
                                            title="Megjegyzés: <?php echo escape(mb_substr($client['notes'], 0, MAX_NOTE_PREVIEW_LENGTH)); ?>"
                                            style="cursor: help;"></i>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <?php else: ?>
                                        <span
                                            style="background-color: #dc3545; color: white; padding: 2px 6px; border-radius: 4px; display: inline-block;">
                                ...
                                <td>
                                    <?php if ($client['agent_name']): ?>
                                        <span class="agent-badge"
                                            style="background-color: <?php echo escape($client['agent_color']); ?>; color: #000;">
    ...
    <!-- Központi CRM script az értesítési SSE és badge frissítésekhez -->
